...
import com.example.user.rxandroidapplication.network.TokenAuthenticator;
import com.example.user.rxandroidapplication.network.service.UserAPIService;
import com.example.user.rxandroidapplication.network.service.UserAPIServiceImpl;
...
public class NetworkUtils {
    ...
    //    public static final String SERVER_IP = "3rdi.xyz";
//    public static final String SERVER_IP = "3rdi-staging.xyzinnotech.com";
//    private static final String BASE_URL = "https://" + SERVER_IP + "";
    ...
    private static okhttp3.Cache provideOkHttpCache(Context mContext) {
    ...
    private static okhttp3.OkHttpClient provideOkHttpClient(Context mContext, boolean enableLogging) {
